...
class ProjectWarehouseViewModel {
    ...
    private fun mockProjectWarehouse() : ArrayList<ProjectWarehouseResponse>{
        ...
        list.add(ProjectWarehouseResponse(name = "dự án mới ", url = "http://a9.vietbao.vn/images/vn999/170/2018/01/20180129-bo-tui-kinh-nghiem-vang-khi-mua-bat-dong-san-cao-cap-2018-1.jpg", location = "12 hai ba trung ha noi", type = 1))
        list.add(ProjectWarehouseResponse(name = "dự án mới ", url = "http://a9.vietbao.vn/images/vn999/170/2018/01/20180129-bo-tui-kinh-nghiem-vang-khi-mua-bat-dong-san-cao-cap-2018-1.jpg", location = "12 hai ba trung ha noi", type = 1))
        list.add(ProjectWarehouseResponse(name = "dự án mới ", url = "http://a9.vietbao.vn/images/vn999/170/2018/01/20180129-bo-tui-kinh-nghiem-vang-khi-mua-bat-dong-san-cao-cap-2018-1.jpg", location = "12 hai ba trung ha noi", type = 1))
        list.add(ProjectWarehouseResponse(name = "dự án mới ", url = "http://a9.vietbao.vn/images/vn999/170/2018/01/20180129-bo-tui-kinh-nghiem-vang-khi-mua-bat-dong-san-cao-cap-2018-1.jpg", location = "12 hai ba trung ha noi", type = 1))
        list.add(ProjectWarehouseResponse(name = "dự án mới ", url = "http://a9.vietbao.vn/images/vn999/170/2018/01/20180129-bo-tui-kinh-nghiem-vang-khi-mua-bat-dong-san-cao-cap-2018-1.jpg", location = "12 hai ba trung ha noi", type = 1))
