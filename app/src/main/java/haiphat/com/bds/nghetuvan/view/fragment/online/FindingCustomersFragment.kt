...
class FindingCustomersFragment : BaseFragment() {
    private lateinit var dataBindingFragmentFindingCustomers: FragmentFindingCustomersBinding


    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        dataBindingFragmentFindingCustomers = DataBindingUtil.inflate(inflater, R.layout.fragment_finding_customers, container, false)
        return dataBindingFragmentFindingCustomers.root
    }
